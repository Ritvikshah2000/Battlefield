...
public class Enemy extends Actor
{
    ...
    public void setContent(Enemy enemy, Cell regularcell)
    {
        regularcell.setEnemy(enemy);
    }

    public void removeContent(Cell regularcell)
    {
        regularcell.removeEnemy();
    }

    public void onHit(Hero hero)
    {
        hero.reduceHealth(hero.getHealth());
